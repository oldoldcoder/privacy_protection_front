<template>
  <div class="container">
    <h1 class="container-title">欧式距离计算</h1>
    <div class="container-tip">
      2个数据拥有者协同计算各自持有的一条数据的欧式距离，由其中一个指定的用户获取最终的计算结果。
    </div>
...
const customRequest = ({ file, onSuccess, onError }) => {
  ...
  axios
    .post('http://10.10.55.25:8082/dd/scc/distance', formData, { withCredentials: true })
    .then((response) => {
