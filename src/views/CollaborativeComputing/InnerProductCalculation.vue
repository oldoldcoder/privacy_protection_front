<template>
  <div class="container">
    <h1 class="container-title">内积计算</h1>
    <div class="container-tip">
      2个数据拥有者各自持有一条d维的数据，两个用户协同计算出两条数据的内积，最后由一个指定的用户解密得出最终的计算结果。
    </div>
...
const customRequest = ({ file, onSuccess, onError }) => {
  ...
  axios
    .post('http://10.10.55.25:8082/dd/scc/inner_product', formData, { withCredentials: true })
    .then((response) => {
