<template>
  <div class="container">
    <h1 class="container-title">最值计算</h1>
    <div class="container-tip">
      N个数据拥有者之间协同计算所用数据中的最大值和最小值，最后由一个指定的用户解密得出最终的计算结果。
    </div>
...
const customRequest = ({ file, onSuccess, onError }) => {
  ...
  axios
    .post('http://10.10.55.25:8082/dd/scc/min_max', formData, { withCredentials: true })
    .then((response) => {
