<template>
  <div class="container">
    <h1 class="container-title">相等测试</h1>
    <div class="container-tip">
      2个数据拥有者协同比较各自持有的一个数据的大小是否相等，由其中一个指定的用户获取最终的比较结果。0代表a ≠ b；1代表a = b。
    </div>
...
const customRequest = ({ file, onSuccess, onError }) => {
  ...
  axios
    .post('http://10.10.55.25:8082/dd/scc/equal', formData, { withCredentials: true })
    .then((response) => {
